...
export default class extends Controller {
  ...
  select(event) {
    ...
    console.log(this.buttonTargets[parseInt(event.currentTarget.value) - this.index_correct(parseInt(event.currentTarget.value))])
    this.buttonTargets[parseInt(event.currentTarget.value) - this.index_correct(parseInt(event.currentTarget.value))].classList.toggle('active-btn');
  }
